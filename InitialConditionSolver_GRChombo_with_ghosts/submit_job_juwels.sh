...
work_dir=/p/home/jusers/bamber1/juwels/Experimental_tools/InitialConditionSolver_GRChombo_with_ghosts
...
do
	...
	name=public_code_with_ghosts_basic_params_non_zero_potential_flat_phi_G0.0000000001_Dirichlet
